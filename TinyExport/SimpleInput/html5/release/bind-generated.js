...
Object.defineProperties(entities.game.NewScene.Component, { cid: { configurable: true, get: function() { delete entities.game.NewScene.Component.cid; var offsetsPtr = 0, offsetsCount = 0; return entities.game.NewScene.Component.cid = Module._ut_component_register_cid(/*entities.game.NewScene.Component*/ 1, 0, 0, offsetsPtr, offsetsCount, 0/*"entities::game::NewScene::Component"*/, 0, 0); } } });
...
game.Ground = function(arg0) {
  this._groundLevel = (+(arg0===undefined ? 0 : arg0));
};
...
Object.defineProperties(game.Ground.prototype, {
  groundLevel: {
    get: function() { return this._groundLevel; },
    set: function(v) { this._groundLevel = (+(v===undefined ? 0 : v)); },
  },
});
game.Ground._size = 4;
game.Ground._fromPtr = function(ptr, v) {
  v = v || Object.create(game.Ground.prototype);
  v._groundLevel = HEAPF32[(ptr+0)>>2];
  return v;
};
game.Ground._toPtr = function(ptr, v) {
  HEAPF32[(ptr+0)>>2] = v.groundLevel;
};
...
Object.defineProperties(game.Ground, { cid: { configurable: true, get: function() { delete game.Ground.cid; var offsetsPtr = 0, offsetsCount = 0; return game.Ground.cid = Module._ut_component_register_cid(/*game.Ground*/ 4, 4, 0, offsetsPtr, offsetsCount, 0/*"game::Ground"*/, 0, 0); } } });
Object.defineProperties(game.Ground.StorageView, { cid: { configurable: true, get: function() { return game.Ground.cid; } } });
game.Ground.groundLevel = { $ofs:0, $t:"float", $c:game.Ground };
...
Object.defineProperties(game.Movement, { cid: { configurable: true, get: function() { delete game.Movement.cid; var offsetsPtr = 0, offsetsCount = 0; return game.Movement.cid = Module._ut_component_register_cid(/*game.Movement*/ 4, 4, 0, offsetsPtr, offsetsCount, 0/*"game::Movement"*/, 0, 0); } } });
