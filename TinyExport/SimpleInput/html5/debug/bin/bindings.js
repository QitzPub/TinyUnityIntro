...
game.Ground._typeDesc = (function() {
  return ut.meta.allocType(5, 'game.Ground', 4, [
    {name: 'groundLevel', offset: 0, type: ut.meta.getType('float')}
  ]);
})();
Object.defineProperties(game.Ground, { cid: { configurable: true, get: function() { delete game.Ground.cid; var offsetsPtr = 0, offsetsCount = 0; return game.Ground.cid = Module._ut_component_register_cid_with_type(game.Ground._typeDesc, 4, 0, offsetsPtr, offsetsCount, 0, 0); } } });
