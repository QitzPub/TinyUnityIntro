...
declare namespace game{
    class ClimbingHitBox extends ut.Component {
        constructor();
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: ClimbingHitBox): ClimbingHitBox;
        static _toPtr(p: number, v: ClimbingHitBox): void;
        static _tempHeapPtr(v: ClimbingHitBox): number;
        static _dtorFn(v: ClimbingHitBox): void;
    }
    ...
    class GameStateDisplay extends ut.Component {
        constructor();
        gameStateStr: string;
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: GameStateDisplay): GameStateDisplay;
        static _toPtr(p: number, v: GameStateDisplay): void;
        static _tempHeapPtr(v: GameStateDisplay): number;
        static _dtorFn(v: GameStateDisplay): void;
    }
    class Goal extends ut.Component {
        constructor();
        isReached: boolean;
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: Goal): Goal;
        static _toPtr(p: number, v: Goal): void;
        static _tempHeapPtr(v: Goal): number;
        static _dtorFn(v: Goal): void;
    }
    ...
    class GroundingHitBox extends ut.Component {
        constructor();
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: GroundingHitBox): GroundingHitBox;
        static _toPtr(p: number, v: GroundingHitBox): void;
        static _tempHeapPtr(v: GroundingHitBox): number;
        static _dtorFn(v: GroundingHitBox): void;
    }
    class Prince extends ut.Component {
        constructor();
        isFlip: boolean;
        state: PrinceMoveState;
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: Prince): Prince;
        static _toPtr(p: number, v: Prince): void;
        static _tempHeapPtr(v: Prince): number;
        static _dtorFn(v: Prince): void;
    }
    class PrinceSpawner extends ut.Component {
        constructor();
        interval: number;
        princes: number;
        time: number;
        ...
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: PrinceSpawner): PrinceSpawner;
        static _toPtr(p: number, v: PrinceSpawner): void;
        static _tempHeapPtr(v: PrinceSpawner): number;
        static _dtorFn(v: PrinceSpawner): void;
    }
    ...
    class ShootNumberDisplay extends ut.Component {
        constructor();
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: ShootNumberDisplay): ShootNumberDisplay;
        static _toPtr(p: number, v: ShootNumberDisplay): void;
        static _tempHeapPtr(v: ShootNumberDisplay): number;
        static _dtorFn(v: ShootNumberDisplay): void;
    }
    class ShootPoint extends ut.Component {
        constructor();
        shoots: number;
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
        static _fromPtr(p: number, v?: ShootPoint): ShootPoint;
        static _toPtr(p: number, v: ShootPoint): void;
        static _tempHeapPtr(v: ShootPoint): number;
        static _dtorFn(v: ShootPoint): void;
    }
    enum GameStateEnum {
        NotInitialized = 0,
        Normal = 1,
...
declare namespace ut{
    ...
    interface EntityGroups{
        ...
        game: {
            ...
            Level0: EntityGroupData;
            PlantEntities: EntityGroupData;
            PrinceEntities: EntityGroupData;
            ShootEntities: EntityGroupData;
            Ground: EntityGroupData;
        }
    }
}
